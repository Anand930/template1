...
const Articles = () => {
    return (
        <div className="Articles App">
            <div className="Articles-components App-components">
                <Navbar />
                <div className="article-container about-container">
                    ...
                    <div className="article-discription">
                        ...
                        <div className="aricle-discription-container">
                            <div className="article-discription-left">
                                <div className="about-date">September 2, 2022</div>
                            </div>
                            <div className="article-discription-right">
                        ...
                        <div className="aricle-discription-container">
                            <div className="article-discription-left">
                                <div className="about-date">July 14, 2022</div>
                            </div>
                            <div className="article-discription-right">
